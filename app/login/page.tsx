      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-brand-500 via-brand-600 to-brand-800 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-16">
          ...
          <h2 className="text-4xl font-extrabold text-white leading-[1.1] mb-4">
            Know when your<br />services go down.
          </h2>
          <p className="text-white/60 text-lg leading-relaxed max-w-md">
            Monitor websites, APIs, and services. Get alerted instantly. Share beautiful status pages.
          </p>
          <div className="mt-12 bg-white/[0.06] backdrop-blur-md rounded-2xl p-5 border border-white/[0.08] max-w-sm">
            <p className="text-white/80 text-sm leading-relaxed italic">
              &ldquo;Set up monitoring in 2 minutes. The status page looks incredible.&rdquo;
            </p>
            <p className="text-white/50 text-xs mt-3">— Early Beta User</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center bg-[#F9FAFB] px-6 sm:px-12">
        <div className="w-full max-w-[400px]">
          ...
          <p className="text-sm text-gray-500 text-center mt-6">
            Don&apos;t have an account? <Link href="/signup" className="text-brand-500 font-medium hover:text-brand-600">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
