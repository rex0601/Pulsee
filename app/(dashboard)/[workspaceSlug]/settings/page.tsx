...
import { Globe, Bell, CreditCard, Users, Settings as SettingsIcon } from 'lucide-react';
      ...
      <div className="flex gap-6">
        ...
        <div className="w-48 shrink-0 space-y-0.5">
          {tabs.map((t) => (
            ...
            >
              <t.icon className={`w-4 h-4 ${activeTab === t.id ? 'text-brand-500' : 'text-gray-400'}`} />
              {t.label}
            </button>
          ))}
        </div>
        ...
        <div className="flex-1 rounded-lg border border-gray-200 bg-white p-6">
          ...
          {activeTab === 'domain' && (
            <div className="space-y-6">
              <div>
                <h3 className="text-[15px] font-semibold text-gray-900 mb-1">Custom Domain</h3>
                <p className="text-sm text-gray-500 mb-4">Use your own domain for your public status page.</p>
          ...
          {activeTab === 'notifications' && (
            <div className="space-y-6">
              <div>
                <h3 className="text-[15px] font-semibold text-gray-900 mb-1">Slack</h3>
                <p className="text-sm text-gray-500 mb-3">Get notified when incidents are detected or resolved.</p>
              ...
              <div>
                <h3 className="text-[15px] font-semibold text-gray-900 mb-1">Email</h3>
                <p className="text-sm text-gray-500 mb-3">Send email alerts to your team.</p>
          ...
          {activeTab === 'billing' && (
            <div className="space-y-6">
              <div>
                <h3 className="text-[15px] font-semibold text-gray-900 mb-1">Current Plan</h3>
